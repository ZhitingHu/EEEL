...
int main(){
  ...
  // Open files
  string dataset_path = "/home/zhitingh/ml_proj/EEEL/data/whole_new/origin";
  string parsed_dataset_path = "/home/zhitingh/ml_proj/EEEL/data/whole_new/pruned_admin_and_meaningless_entities";
  ...
  while (getline(pair_file, line)){
    ...
    if (tokens.size() != 3){
      cout << "Err: Pair format should with len 3: " << line << endl;
      break;
    }
